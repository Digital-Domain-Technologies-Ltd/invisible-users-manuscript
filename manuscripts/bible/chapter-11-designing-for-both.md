---
title: "Designing for Both"
description: "Solutions that work for AI agents without degrading the human experience, using universal design patterns"
...
**Connecting to Chapter 10:** The previous chapter established how to make your site discoverable to agents through GEO (Generative Engine Optimisation) - ensuring AI platforms can find and cite your content accurately. This chapter builds on that foundation by showing how to make your site usable once agents arrive. Discovery (Chapter 10) and usability (this chapter) form a unified strategy: structured data that helps agents cite you correctly also helps them complete transactions successfully. The convergence continues: discovery patterns naturally lead to usability patterns. Chapter 10 solved the discovery problem—ensuring agents can find you, cite you accurately, and understand your offerings. This chapter solves the transaction problem—ensuring agents can complete tasks successfully once they arrive. Both are required. Discovery without transaction-readiness wastes the opportunity. Transaction-readiness without discovery means agents never arrive. Discovery precedes commerce, but commerce requires both layers working together.
